...
import domimg from "../MainDashboard/NetworkImages/Domain.png";
import orgimg from "../MainDashboard/NetworkImages/Organization.png";
import grpimg from "../MainDashboard/NetworkImages/groups.png";
import usrimg from "../MainDashboard/NetworkImages/users.png";
import datasrc from "../MainDashboard/NetworkImages/datasources.png";
import dblist from "../MainDashboard/NetworkImages/dashboard.png";

function Final() {
  const navigate = useNavigate();
  const [navigationButtonsEnabled, setNavigationButtonsEnabled] =
    useState(false);
  const [physicsvalue, setPhysicsvalue] = useState(true);
  ...
  const handleToggleButtons = () => {
    ...
    setPhysicsvalue((prevState) => !prevState);
  };
  ...
  return (
    <>
      ...
      <button onClick={handleToggleButtonClick} style={bs}>
        {isButtonEnabled ? "ImageVersion" : "NodeVersion"}
      </button>
      {isButtonEnabled ? navigate(`/networknode`) : ""}
    </>
  );
}
